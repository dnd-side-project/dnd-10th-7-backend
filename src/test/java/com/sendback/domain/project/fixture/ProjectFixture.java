...
public class ProjectFixture {
    ...
    public static final SaveProjectRequest mock_saveProjectRequest = new SaveProjectRequest(TITLE, FIELD, CONTENT, DEMO_SITE_URL, START_DATE,
    ...
    public static final UpdateProjectRequest mock_updateProjectRequest = new UpdateProjectRequest(
            UPDATE_TITLE, UPDATE_FIELD, UPDATE_CONTENT, UPDATE_DEMO_SITE_URL, UPDATE_START_DATE, UPDATE_END_DATE, DEVELOPING_PROGRESS.toString(),
